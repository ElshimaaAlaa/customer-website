...
function Promotions() {
  ...
  const allPromotionItems = promotions.flatMap(promotion => 
  ...
  return (
    <div className="px-4 md:px-20 py-5 relative">
      <h1 className="text-lg font-bold mb-6">Promotions</h1>
      {error ? (
        ...
        <div className="relative">
          ...
          >
            {allPromotionItems.map((product, index) => (
                      ...
                      <div className="flex h-56 mx-3 items-end">
                        <div>
                          <h3 className="font-bold text-white text-xl mt-3">
                            {product.promotionName || product.name}
                          </h3>

  ...
  return (
    <div className="px-4 md:px-20 py-10 relative">
      <div className="flex justify-between items-center">
        ...
        <button className="text-primary w-32 flex items-center rounded-md justify-center font-bold p-3 gap-2">View All <IoIosArrowRoundForward size={25}/></button>
      </div>
      {error ? (
                  ...
                  <div className="relative bg-gray-50 border rounded-md flex justify-center">
                    ...
                    {product.images?.[0]?.src && (
                      <img
                        ...
                        alt={product.name}
                        className="w-48 h-72 py-3 rounded-lg"
                        onError={(e) => {
